                ...
                <div class="col-md-4 card shadow py-2 m-1">
                    <div class="d-flex">
                        ...
                        <div>
                                       ...
                                       <div class="container my-2">
                                           ...
                                           <div class="row">
                                               <div class="row">
                                                   ...
                                                   <div class="col">
                                                        <div class="col-md-12">
                                                            <input type="text" name="name" class="form-control" placeholder="Patient Name" value="{{ Auth::user()->name }}">
                                                        </div>
                                                   </div>
                                               </div>
                            ...
                            @else
                                <a href="/login" class="btn btn-primary btn-danger btn-sm">Book Appointment</a>    
                            @endif
